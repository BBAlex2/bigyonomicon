...
<div class="col-12 bg-dark p-2 py-4 mx-auto justify-content-center">
    ...
    <div id="parameterFrame" class="px-4 fs-4 row" style="display: none">
        ...
        <div class="col-6 flex flex-col g-2">
            ...
            <div>
                <i class="bi bi-plus-circle clr-yellow mr-2"></i><span class="clr-yellow">Ülőhelyek</span>
                <p class="clr-light">3 személy</p>
            </div>
            <div>
                <i class="bi bi-tools clr-yellow mr-2"></i><span class="clr-yellow">Karbantartás</span>
                <p class="clr-light">Speciális bőrápoló készítménnyel tisztítható</p>
            </div>
            <div>
                <i class="bi bi-shield-check clr-yellow mr-2"></i><span class="clr-yellow">Garancia</span>
                <p class="clr-light">10 év</p>
            </div>
        </div>
    </div>
