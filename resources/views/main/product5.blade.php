    ...
    <div id="parameterFrame" class="px-4 fs-4 row" style="display: none">
        <div class="col-6 flex flex-col g-2">
            <div>
                ...
                <p class="clr-light">35cm x 35cm x 160cm (H x Sz x M)</p>
            </div>
            <div>
                <i class="bi bi-box-fill clr-yellow mr-2"></i><span class="clr-yellow">Súly</span>
                <p class="clr-light">8 Kg</p>
            </div>
            <div>
                <i class="bi bi-palette-fill clr-yellow mr-2"></i><span class="clr-yellow">Szín</span>
                <p class="clr-light">Antikolt réz</p>
            </div>
            <div>
                <i class="bi bi-tree-fill clr-yellow mr-2"></i><span class="clr-yellow">Anyag</span>
                <p class="clr-light">Tölgyfa, lenvászon, öntöttvas talp</p>
            </div>
        </div>
        <div class="col-6 flex flex-col g-2">
            <div>
                <i class="bi bi-archive-fill clr-yellow mr-2"></i><span class="clr-yellow">Raktáron</span>
                <p class="clr-light">7 db</p>
            </div>
            <div>
                <i class="bi bi-lightbulb-fill clr-yellow mr-2"></i><span class="clr-yellow">Izzó típus</span>
                <p class="clr-light">E27, max 60W (nem tartozék)</p>
            </div>
            <div>
                <i class="bi bi-tools clr-yellow mr-2"></i><span class="clr-yellow">Összeszerelés</span>
                <p class="clr-light">Minimális összeszerelést igényel</p>
            </div>
            <div>
                <i class="bi bi-shield-check clr-yellow mr-2"></i><span class="clr-yellow">Garancia</span>
                <p class="clr-light">2 év</p>
            </div>
        </div>
    </div>
