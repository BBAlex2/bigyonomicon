    ...
    <div id="parameterFrame" class="px-4 fs-4 row" style="display: none">
        <div class="col-6 flex flex-col g-2">
            <div>
                ...
                <p class="clr-light">Amerikai Egyesült Államok</p>
            </div>
            <div>
                <i class="bi bi-box-fill clr-yellow mr-2"></i><span class="clr-yellow">Méret</span>
                <p class="clr-light">0.76x0.76x0.76 m</p>
            </div>
            <div>
                <i class="bi bi-palette-fill clr-yellow mr-2"></i><span class="clr-yellow">Szín</span>
                <p class="clr-light">Fémfehér</p>
            </div>
            <div>
                <i class="bi bi-droplet-fill clr-yellow mr-2"></i><span class="clr-yellow">Aggresszív</span>
                <p class="clr-light">Nem</p>
            </div>
        </div>
        <div class="col-6 flex flex-col g-2">
            <div>
