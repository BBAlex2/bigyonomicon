...
<div class="col-12 bg-dark p-2 py-4 mx-auto justify-content-center">
    ...
    <div id="parameterFrame" class="px-4 fs-4 row" style="display: none">
        <div class="col-6 flex flex-col g-2">
            <div>
                <i class="bi bi-geo-alt-fill clr-yellow mr-2"></i><span class="clr-yellow">Származási hely</span>
                <p class="clr-light">Magyarország, Szabolcs-Szatmár-Bereg megye</p>
            </div>
            <div>
                <i class="bi bi-box-fill clr-yellow mr-2"></i><span class="clr-yellow">Átlagos méret</span>
                <p class="clr-light">7-8 cm átmérő</p>
            </div>
            <div>
                <i class="bi bi-palette-fill clr-yellow mr-2"></i><span class="clr-yellow">Szín</span>
                <p class="clr-light">Zöld</p>
            </div>
            <div>
                <i class="bi bi-droplet-fill clr-yellow mr-2"></i><span class="clr-yellow">Íz</span>
                <p class="clr-light">Édes-savanykás</p>
            </div>
        </div>
        <div class="col-6 flex flex-col g-2">
            <div>
                <i class="bi bi-archive-fill clr-yellow mr-2"></i><span class="clr-yellow">Raktáron</span>
                <p class="clr-light">50 kg</p>
            </div>
            <div>
                <i class="bi bi-calendar-check clr-yellow mr-2"></i><span class="clr-yellow">Szavatosság</span>
                <p class="clr-light">Hűtve 2 hét</p>
            </div>
            <div>
                <i class="bi bi-egg-fill clr-yellow mr-2"></i><span class="clr-yellow">Egy darab súlya</span>
                <p class="clr-light">~180-200 g</p>
            </div>
        </div>
        <div class="col-12 mt-4">
            <h4 class="clr-yellow">Tápanyagtartalom (100g)</h4>
            <div class="row">
                <div class="col-6">
                    <div>
                        <i class="bi bi-lightning-fill clr-yellow mr-2"></i><span class="clr-yellow">Kalória</span>
                        <p class="clr-light">52 kcal</p>
                    </div>
                    <div>
                        <i class="bi bi-circle-fill clr-yellow mr-2"></i><span class="clr-yellow">Szénhidrát</span>
                        <p class="clr-light">14 g (ebből cukor: 10 g)</p>
                    </div>
                    <div>
                        <i class="bi bi-circle-fill clr-yellow mr-2"></i><span class="clr-yellow">Fehérje</span>
                        <p class="clr-light">0.3 g</p>
                    </div>
                </div>
                <div class="col-6">
                    <div>
                        <i class="bi bi-circle-fill clr-yellow mr-2"></i><span class="clr-yellow">Zsír</span>
                        <p class="clr-light">0.2 g</p>
                    </div>
                    <div>
                        <i class="bi bi-circle-fill clr-yellow mr-2"></i><span class="clr-yellow">Rost</span>
                        <p class="clr-light">2.4 g</p>
                    </div>
                    <div>
                        <i class="bi bi-capsule-pill clr-yellow mr-2"></i><span class="clr-yellow">Vitaminok</span>
                        <p class="clr-light">C, A, E, K, B6, folát</p>
                    </div>
                </div>
            </div>
        </div>
