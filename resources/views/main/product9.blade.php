    ...
    <div id="parameterFrame" class="px-4 fs-4 row" style="display: none">
        <div class="col-6 flex flex-col g-2">
            <div>
                ...
                <p class="clr-light">Egyesült Királyság</p>
            </div>
            <div>
                <i class="bi bi-box-fill clr-yellow mr-2"></i><span class="clr-yellow">Méret</span>
                <p class="clr-light">16x22x16 cm</p>
            </div>
            <div>
                <i class="bi bi-palette-fill clr-yellow mr-2"></i><span class="clr-yellow">Szín</span>
                <p class="clr-light">Rozsdaszínű</p>
            </div>
            <div>
                <i class="bi bi-droplet-fill clr-yellow mr-2"></i><span class="clr-yellow">Potenciál</span>
                <p class="clr-light">0.2 kilotonna</p>
            </div>
        </div>
        <div class="col-6 flex flex-col g-2">
            <div>
                <i class="bi bi-archive-fill clr-yellow mr-2"></i><span class="clr-yellow">Raktáron</span>
                <p class="clr-light">1 Db</p>
            </div>
            <div>
                <i class="bi bi-calendar-check clr-yellow mr-2"></i><span class="clr-yellow">Gyártási Év</span>
                <p class="clr-light">1979</p>
            </div>
            <div>
                <i class="bi bi-egg-fill clr-yellow mr-2"></i><span class="clr-yellow">Egy darab súlya</span>
                <p class="clr-light">~300-350 g</p>
            </div>
        </div>
    </div>
