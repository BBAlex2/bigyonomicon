    ...
    public function run(): void
    {
        $products = [
            ...
            7 => [
                ...
                'subcategory_id' => 26, // Gyümölcs
            ],
            8 => [
                'name' => 'Súlyozott Házastárs Téglatest',
                'description' => 'A Súlyozott Házastárs Téglatest lehet hogy érez, vagy nem. Exotikus addició lehet bármely háztartásba, feldobva a fürdőszobától kezdve a hálószobáig bármely térséget. A téglatest soha nem fog azzal fenyegetni, hogy késsel megszúr, mivel tény szerint nem tud beszélni.',
                'price' => 67900,
                'image' => 'bigyo8.png',
                'rating' => 9.0,
                'rating_count' => 4,
            ...
            9 => [
                ...
                'description' => 'Az Antióchiai Szent Kézigránát egy különleges eszköz, mellyel megoldhatja élete főbb problémáit. Rendkívül hatásos nyulak hatástalanításában, esküvők felfüggesztésében, valamint bevásárlásnál. Eredete visszavezethető a 15. századi Egyesült Királysághoz, így gyűjtők számára egy elengedhetetlen darab. Artúr Király személyesen ajánlja.',
                'price' => 549900,
                'image' => 'bigyo9.png',
                'rating' => 9.2,
                'rating_count' => 8,
                'category_id' => 4, // Sport és szabadidő
                'subcategory_id' => 24, // Kézigránát
            ],
        ];
